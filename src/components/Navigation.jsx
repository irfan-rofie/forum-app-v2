...
function Navigation() {
  ...
  return (
    <div className="navigation-bottom">
      <nav>
        <button type="button" className="navigation-item" onClick={onThreadsClick}>
        ...
        <button type="button" className="navigation-item" onClick={onLeaderboardsClick}>
          <div className="navigation-item__icon">
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <button type="button" className="navigation-item" onClick={onLogoutClick}>
          <div className="navigation-item__icon">
